...
def cube(position, gltype, batch, vector):
    ...
    batch.add(4, gltype, None, ('v3f', (X, y, z, x, y, z, x, Y, z, X, Y, z)), ('c4B', (255, 255, 0, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255)))
    batch.add(4, gltype, None, ('v3f', (x, y, Z, X, y, Z, X, Y, Z, x, Y, Z)), ('c4B', (255, 255, 0, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255)))
    batch.add(4, gltype, None, ('v3f', (x, y, z, x, y, Z, x, Y, Z, x, Y, z)), ('c4B', (255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255)))
    batch.add(4, gltype, None, ('v3f', (X, y, Z, X, y, z, X, Y, z, X, Y, Z)), ('c4B', (255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255)))
    batch.add(4, gltype, None, ('v3f', (x, y, z, X, y, z, X, y, Z, x, y, Z)), ('c4B', (255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255)))
    batch.add(4, gltype, None, ('v3f', (x, Y, Z, X, Y, Z, X, Y, z, x, Y, z)), ('c4B', (255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255, 255, 0, 255, 255)))
